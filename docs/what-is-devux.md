...
<div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 10px;">
  <div style="display: flex; align-items: center; gap: 8px;"><img src="/profpic.jpg" alt="Inas Sirhan" class="author-pic"><span>Created by <a href="https://linkedin.com/in/inas-sirhan" target="_blank">Inas Sirhan</a></span></div>
